          ...
          <div className='w-full inline-grid place-items-center text-primary font-black'>
            <div className=' inline-grid place-items-center'>
              <div className=' flex items-center flex-col sm:flex-row gap-4 justify-center'>
                <img src={profileAvatar} alt='av' className='w-16 h-16 rounded-full bg-primaryLight' />
              ...
              <div className='w-full -mt-2'>
                <div className='flex flex-col items-end justify-center'>
                  <div className='text-base font-normal text-cblack'><span>Joined on </span><span className=' font-semibold'>0</span></div>
                </div>
              </div>
            </div>
          </div>
